...
<body>
	...
	<div align="center" style="margin-top: 30px">
		<table>
			<tr>
				<td>职位名称：</td>
				<td><input type="text"  /><font color="red" size="5">*</font>
				</td>
			</tr>
			<tr>
				<td>职位描述：</td>
				<td><textarea  cols="50" rows="10"></textarea> <font color="red" size="5">*</font></td>
			</tr>
			<tr>
			...
			<tr>
				<td>
					<input type="submit"  value="提交" style="height:30px;width:60px" />
				</td>
				<td>
